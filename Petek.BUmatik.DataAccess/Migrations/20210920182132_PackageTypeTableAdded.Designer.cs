...
namespace Petek.BUmatik.DataAccess.Migrations
{
    ...
    [Migration("20210920182132_PackageTypeTableAdded")]
    partial class PackageTypeTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            Email = "eren@petek.com",
                            FullName = "Eren İnal",
                            IsDeleted = false,
                            PasswordHash = new byte[] { 125, 251, 70, 58, 86, 186, 215, 100, 210, 223, 99, 228, 62, 54, 95, 6, 210, 114, 238, 156, 163, 13, 196, 226, 155, 182, 89, 156, 18, 222, 155, 88, 21, 134, 130, 229, 248, 197, 47, 246, 88, 209, 196, 191, 102, 97, 72, 94, 16, 103, 206, 91, 235, 7, 141, 125, 67, 224, 201, 224, 227, 130, 158, 102 },
                            PasswordSalt = new byte[] { 163, 21, 180, 177, 15, 9, 38, 159, 2, 112, 130, 64, 9, 34, 134, 117, 89, 188, 211, 222, 21, 209, 10, 164, 45, 241, 244, 48, 233, 79, 94, 91, 243, 189, 113, 242, 164, 98, 255, 160, 94, 64, 101, 234, 253, 215, 13, 176, 220, 133, 100, 219, 96, 202, 105, 79, 104, 52, 67, 240, 235, 163, 87, 140, 239, 240, 184, 169, 16, 84, 255, 106, 175, 162, 62, 3, 154, 197, 122, 65, 40, 179, 69, 155, 178, 253, 229, 131, 74, 94, 48, 222, 90, 152, 134, 244, 133, 231, 17, 207, 29, 189, 114, 51, 93, 178, 114, 230, 80, 101, 23, 93, 59, 47, 77, 112, 33, 150, 89, 229, 162, 81, 208, 241, 83, 2, 145, 9 }
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.AutomatInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedUserId = 1,
                            IsDeleted = false,
                            LastRepairDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            Number = "BUMATIK-1",
                            SchoolId = 1,
                            StartDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.AutomatItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            CreatedUserId = 1,
                            ImagePath = "../../../assets/img/automatItems/items-1.jpg",
                            IsDeleted = false,
                            ItemCategoryId = 3,
                            Name = "Portakal",
                            Price = 2m
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 34,
                            CreatedDate = new DateTime(2021, 9, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            CreatedUserId = 1,
                            IsDeleted = false,
                            Name = "Sarıyer"
                        },
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.MenuType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            CreatedUserId = 1,
                            FinishDate = new TimeSpan(0, 15, 0, 0, 0),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.PackageType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.Parent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            CreatedUserId = 1,
                            Email = "pelinsu.baltaci@petek.com",
                            FullName = "Pelinsu Baltacı",
                            IsDeleted = false,
                            PasswordHash = new byte[] { 125, 251, 70, 58, 86, 186, 215, 100, 210, 223, 99, 228, 62, 54, 95, 6, 210, 114, 238, 156, 163, 13, 196, 226, 155, 182, 89, 156, 18, 222, 155, 88, 21, 134, 130, 229, 248, 197, 47, 246, 88, 209, 196, 191, 102, 97, 72, 94, 16, 103, 206, 91, 235, 7, 141, 125, 67, 224, 201, 224, 227, 130, 158, 102 },
                            PasswordSalt = new byte[] { 163, 21, 180, 177, 15, 9, 38, 159, 2, 112, 130, 64, 9, 34, 134, 117, 89, 188, 211, 222, 21, 209, 10, 164, 45, 241, 244, 48, 233, 79, 94, 91, 243, 189, 113, 242, 164, 98, 255, 160, 94, 64, 101, 234, 253, 215, 13, 176, 220, 133, 100, 219, 96, 202, 105, 79, 104, 52, 67, 240, 235, 163, 87, 140, 239, 240, 184, 169, 16, 84, 255, 106, 175, 162, 62, 3, 154, 197, 122, 65, 40, 179, 69, 155, 178, 253, 229, 131, 74, 94, 48, 222, 90, 152, 134, 244, 133, 231, 17, 207, 29, 189, 114, 51, 93, 178, 114, 230, 80, 101, 23, 93, 59, 47, 77, 112, 33, 150, 89, 229, 162, 81, 208, 241, 83, 2, 145, 9 }
                        },
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 9, 20, 21, 21, 31, 6, DateTimeKind.Local).AddTicks(970),
                            CreatedUserId = 1,
                            Email = "kemal.sarikaya@petek.com",
                            FullName = "Mehmet Kemal Sarıkaya",
                            IsDeleted = false,
                            PasswordHash = new byte[] { 125, 251, 70, 58, 86, 186, 215, 100, 210, 223, 99, 228, 62, 54, 95, 6, 210, 114, 238, 156, 163, 13, 196, 226, 155, 182, 89, 156, 18, 222, 155, 88, 21, 134, 130, 229, 248, 197, 47, 246, 88, 209, 196, 191, 102, 97, 72, 94, 16, 103, 206, 91, 235, 7, 141, 125, 67, 224, 201, 224, 227, 130, 158, 102 },
                            PasswordSalt = new byte[] { 163, 21, 180, 177, 15, 9, 38, 159, 2, 112, 130, 64, 9, 34, 134, 117, 89, 188, 211, 222, 21, 209, 10, 164, 45, 241, 244, 48, 233, 79, 94, 91, 243, 189, 113, 242, 164, 98, 255, 160, 94, 64, 101, 234, 253, 215, 13, 176, 220, 133, 100, 219, 96, 202, 105, 79, 104, 52, 67, 240, 235, 163, 87, 140, 239, 240, 184, 169, 16, 84, 255, 106, 175, 162, 62, 3, 154, 197, 122, 65, 40, 179, 69, 155, 178, 253, 229, 131, 74, 94, 48, 222, 90, 152, 134, 244, 133, 231, 17, 207, 29, 189, 114, 51, 93, 178, 114, 230, 80, 101, 23, 93, 59, 47, 77, 112, 33, 150, 89, 229, 162, 81, 208, 241, 83, 2, 145, 9 }
            ...
            modelBuilder.Entity("Petek.BUmatik.Entities.Concrete.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2021, 6, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedUserId = 1,
                            IsDeleted = false,
                            ItemCount = 1,
                            MenuTypeId = 2,
