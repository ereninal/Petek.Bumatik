...
namespace Petek.BUmatik.Shared.Constants
{
    ...
    {
        public static string ConnectionStringLocal = "User ID=postgres;Password=$XWsb4vc;Server=127.0.0.1;Port=5432;Database=BUmatik;Integrated Security = true; Pooling=true;";
